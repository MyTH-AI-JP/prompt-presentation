...
import { getOpenAIApiKey, getGeminiApiKey } from './api-keys';
...
export async function generateWithOpenAI(prompt, slideCount, theme, presentationStyle, contentDepth, languageStyle, slideStructure, tags) {
  try {
...
export async function generateWithGemini(prompt, slideCount, theme, presentationStyle, contentDepth, languageStyle, slideStructure, tags) {
  try {
